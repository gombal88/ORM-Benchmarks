...
/**
 * Entity mapped to table MULTI_TABLE03.
 */
public class MultiTable03 {
    ...
    private Long MultiTable03Id;

    /** Used to resolve relations */
    private transient DaoSession daoSession;

    /** Used for active entity operations. */
    private transient MultiTable03Dao myDao;

    private MultiTable04 multiTable04;
    private Long multiTable04__resolvedKey;


    public MultiTable03() {
    }

    public MultiTable03(Long id) {
        this.id = id;
    }

    public MultiTable03(Long id, short SampleStringColl01, Short SampleStringColl02, Short SampleStringColl03, Short SampleStringColl04, Short SampleStringColl05, Short SampleStringColl06, Short SampleStringColl07, Short SampleStringColl08, Short SampleStringColl09, Short SampleStringColl10, int SampleIntColl01, Integer SampleIntColl02, Double SampleRealColl01, Double SampleRealColl02, Integer SampleIntCollIndexed, Long MultiTable03Id) {
        this.id = id;
        ...
        this.MultiTable03Id = MultiTable03Id;
    }

    /** called by internal mechanisms, do not call yourself. */
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getMultiTable03Dao() : null;
    }
    ...
    public Long getMultiTable03Id() {
        return MultiTable03Id;
    }

    public void setMultiTable03Id(Long MultiTable03Id) {
        this.MultiTable03Id = MultiTable03Id;
    }

    /** To-one relationship, resolved on first access. */
    public MultiTable04 getMultiTable04() {
        Long __key = this.MultiTable03Id;
        if (multiTable04__resolvedKey == null || !multiTable04__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            MultiTable04Dao targetDao = daoSession.getMultiTable04Dao();
            MultiTable04 multiTable04New = targetDao.load(__key);
            synchronized (this) {
                multiTable04 = multiTable04New;
            	multiTable04__resolvedKey = __key;
            }
        }
        return multiTable04;
    }

    public void setMultiTable04(MultiTable04 multiTable04) {
        synchronized (this) {
            this.multiTable04 = multiTable04;
            MultiTable03Id = multiTable04 == null ? null : multiTable04.getId();
            multiTable04__resolvedKey = MultiTable03Id;
        }
    }
