...
/** 
 * DAO for table MULTI_TABLE_03.
*/
public class MultiTable_03Dao extends AbstractDao<MultiTable_03, Long> {

    public static final String TABLENAME = "MULTI_TABLE_03";

    /**
     * Properties of entity MultiTable_03.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property MultiTable_04Id = new Property(16, Long.class, "MultiTable_04Id", false, "MULTI_TABLE_04_ID");
    };

    private DaoSession daoSession;


    public MultiTable_03Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable_03Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE_03' (" + //
                ...
                "'MULTI_TABLE_04_ID' INTEGER);"); // 16: MultiTable_04Id
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE_03_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE_03" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE_03'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable_03 entity) {
        stmt.clearBindings();
        ...
        Long MultiTable_04Id = entity.getMultiTable_04Id();
        if (MultiTable_04Id != null) {
            stmt.bindLong(17, MultiTable_04Id);
        }
    }

    @Override
    protected void attachEntity(MultiTable_03 entity) {
    ...
    /** @inheritdoc */
    @Override
    public MultiTable_03 readEntity(Cursor cursor, int offset) {
        MultiTable_03 entity = new MultiTable_03( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // MultiTable_04Id
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable_03 entity, int offset) {
        ...
        entity.setMultiTable_04Id(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable_03 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable_03 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMultiTable_04Dao().getAllColumns());
            builder.append(" FROM MULTI_TABLE_03 T");
            builder.append(" LEFT JOIN MULTI_TABLE_04 T0 ON T.'MULTI_TABLE_04_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected MultiTable_03 loadCurrentDeep(Cursor cursor, boolean lock) {
        MultiTable_03 entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        MultiTable_04 multiTable_04 = loadCurrentOther(daoSession.getMultiTable_04Dao(), cursor, offset);
        entity.setMultiTable_04(multiTable_04);

        return entity;    
    }

    public MultiTable_03 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<MultiTable_03> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<MultiTable_03> list = new ArrayList<MultiTable_03>(count);
    ...
    protected List<MultiTable_03> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<MultiTable_03> queryDeep(String where, String... selectionArg) {
