...
/** 
 * DAO for table MULTI_TABLE_04.
*/
public class MultiTable_04Dao extends AbstractDao<MultiTable_04, Long> {

    public static final String TABLENAME = "MULTI_TABLE_04";

    /**
     * Properties of entity MultiTable_04.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property MultiTable_05Id = new Property(16, Long.class, "MultiTable_05Id", false, "MULTI_TABLE_05_ID");
    };

    private DaoSession daoSession;


    public MultiTable_04Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable_04Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE_04' (" + //
                ...
                "'MULTI_TABLE_05_ID' INTEGER);"); // 16: MultiTable_05Id
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE_04_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE_04" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE_04'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable_04 entity) {
        stmt.clearBindings();
        ...
        Long MultiTable_05Id = entity.getMultiTable_05Id();
        if (MultiTable_05Id != null) {
            stmt.bindLong(17, MultiTable_05Id);
        }
    }

    @Override
    protected void attachEntity(MultiTable_04 entity) {
    ...
    /** @inheritdoc */
    @Override
    public MultiTable_04 readEntity(Cursor cursor, int offset) {
        MultiTable_04 entity = new MultiTable_04( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // MultiTable_05Id
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable_04 entity, int offset) {
        ...
        entity.setMultiTable_05Id(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable_04 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable_04 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMultiTable_05Dao().getAllColumns());
            builder.append(" FROM MULTI_TABLE_04 T");
            builder.append(" LEFT JOIN MULTI_TABLE_05 T0 ON T.'MULTI_TABLE_05_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected MultiTable_04 loadCurrentDeep(Cursor cursor, boolean lock) {
        MultiTable_04 entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        MultiTable_05 multiTable_05 = loadCurrentOther(daoSession.getMultiTable_05Dao(), cursor, offset);
        entity.setMultiTable_05(multiTable_05);

        return entity;    
    }

    public MultiTable_04 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<MultiTable_04> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<MultiTable_04> list = new ArrayList<MultiTable_04>(count);
    ...
    protected List<MultiTable_04> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<MultiTable_04> queryDeep(String where, String... selectionArg) {
