...
public class MultiTable_05Dao extends BaseSampleDao<MultiTable_05> {
    ...
    protected long saveAction(SQLiteDatabase db, MultiTable_05 entity) {
        long nestedTableID = new MultiTable_06Dao().saveAction(db, entity.getMultiTable_06());
        entity.getMultiTable_06().setId(nestedTableID);
    ...
    protected int updateAction(SQLiteDatabase db, MultiTable_05 entity, String selection, String[] selectionArgs) {
        new MultiTable_06Dao().updateAction(db, entity.getMultiTable_06(), BaseColumns._ID + " = ? ", new String[]{String.valueOf(entity.getMultiTable_06().getId())});
