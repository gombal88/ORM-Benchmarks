...
@Table(name = BigSingleTable.TABLE_NAME, id = BaseColumns._ID)
public class BigSingleTable extends BaseSimpleEntity {
    ...
    @Column(name = EXTRA_SAMPLE_STRING_COLL_01)
    private String ExtraSmplStringColl01;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_02)
    private String ExtraSmplStringColl02;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_03)
    private String ExtraSmplStringColl03;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_04)
    private String ExtraSmplStringColl04;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_05)
    private String ExtraSmplStringColl05;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_06)
    private String ExtraSmplStringColl06;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_07)
    private String ExtraSmplStringColl07;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_08)
    private String ExtraSmplStringColl08;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_09)
    private String ExtraSmplStringColl09;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_10)
    private String ExtraSmplStringColl10;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_11)
    private String ExtraSmplStringColl11;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_12)
    private String ExtraSmplStringColl12;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_13)
    private String ExtraSmplStringColl13;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_14)
    private String ExtraSmplStringColl14;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_15)
    private String ExtraSmplStringColl15;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_16)
    private String ExtraSmplStringColl16;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_17)
    private String ExtraSmplStringColl17;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_18)
    private String ExtraSmplStringColl18;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_19)
    private String ExtraSmplStringColl19;

    @Column(name = EXTRA_SAMPLE_STRING_COLL_20)
    private String ExtraSmplStringColl20;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_01)
    private Double ExtraSmplDoubleColl01;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_02)
    private Double ExtraSmplDoubleColl02;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_03)
    private Double ExtraSmplDoubleColl03;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_04)
    private Double ExtraSmplDoubleColl04;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_05)
    private Double ExtraSmplDoubleColl05;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_06)
    private Double ExtraSmplDoubleColl06;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_07)
    private Double ExtraSmplDoubleColl07;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_08)
    private Double ExtraSmplDoubleColl08;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_09)
    private Double ExtraSmplDoubleColl09;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_10)
    private Double ExtraSmplDoubleColl10;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_11)
    private Double ExtraSmplDoubleColl11;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_12)
    private Double ExtraSmplDoubleColl12;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_13)
    private Double ExtraSmplDoubleColl13;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_14)
    private Double ExtraSmplDoubleColl14;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_15)
    private Double ExtraSmplDoubleColl15;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_16)
    private Double ExtraSmplDoubleColl16;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_17)
    private Double ExtraSmplDoubleColl17;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_18)
    private Double ExtraSmplDoubleColl18;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_19)
    private Double ExtraSmplDoubleColl19;

    @Column(name = EXTRA_SAMPLE_DOUBLE_COLL_20)
