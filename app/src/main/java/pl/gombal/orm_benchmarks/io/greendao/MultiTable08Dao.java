...
/** 
 * DAO for table MULTI_TABLE08.
*/
public class MultiTable08Dao extends AbstractDao<MultiTable08, Long> {

    public static final String TABLENAME = "MULTI_TABLE08";

    /**
     * Properties of entity MultiTable08.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property MultiTable08Id = new Property(16, Long.class, "MultiTable08Id", false, "MULTI_TABLE08_ID");
    };

    private DaoSession daoSession;


    public MultiTable08Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable08Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE08' (" + //
                ...
                "'MULTI_TABLE08_ID' INTEGER);"); // 16: MultiTable08Id
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE08_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE08" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE08'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable08 entity) {
        stmt.clearBindings();
        ...
        Long MultiTable08Id = entity.getMultiTable08Id();
        if (MultiTable08Id != null) {
            stmt.bindLong(17, MultiTable08Id);
        }
    }

    @Override
    protected void attachEntity(MultiTable08 entity) {
    ...
    /** @inheritdoc */
    @Override
    public MultiTable08 readEntity(Cursor cursor, int offset) {
        MultiTable08 entity = new MultiTable08( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // MultiTable08Id
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable08 entity, int offset) {
        ...
        entity.setMultiTable08Id(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable08 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable08 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMultiTable09Dao().getAllColumns());
            builder.append(" FROM MULTI_TABLE08 T");
            builder.append(" LEFT JOIN MULTI_TABLE09 T0 ON T.'MULTI_TABLE08_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected MultiTable08 loadCurrentDeep(Cursor cursor, boolean lock) {
        MultiTable08 entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        MultiTable09 multiTable09 = loadCurrentOther(daoSession.getMultiTable09Dao(), cursor, offset);
        entity.setMultiTable09(multiTable09);

        return entity;    
    }

    public MultiTable08 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<MultiTable08> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<MultiTable08> list = new ArrayList<MultiTable08>(count);
    ...
    protected List<MultiTable08> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<MultiTable08> queryDeep(String where, String... selectionArg) {
