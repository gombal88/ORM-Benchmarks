...
/** 
 * DAO for table MULTI_TABLE04.
*/
public class MultiTable04Dao extends AbstractDao<MultiTable04, Long> {

    public static final String TABLENAME = "MULTI_TABLE04";

    /**
     * Properties of entity MultiTable04.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property MultiTable04Id = new Property(16, Long.class, "MultiTable04Id", false, "MULTI_TABLE04_ID");
    };

    private DaoSession daoSession;


    public MultiTable04Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable04Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE04' (" + //
                ...
                "'MULTI_TABLE04_ID' INTEGER);"); // 16: MultiTable04Id
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE04_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE04" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE04'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable04 entity) {
        stmt.clearBindings();
        ...
        Long MultiTable04Id = entity.getMultiTable04Id();
        if (MultiTable04Id != null) {
            stmt.bindLong(17, MultiTable04Id);
        }
    }

    @Override
    protected void attachEntity(MultiTable04 entity) {
    ...
    /** @inheritdoc */
    @Override
    public MultiTable04 readEntity(Cursor cursor, int offset) {
        MultiTable04 entity = new MultiTable04( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // MultiTable04Id
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable04 entity, int offset) {
        ...
        entity.setMultiTable04Id(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable04 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable04 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMultiTable05Dao().getAllColumns());
            builder.append(" FROM MULTI_TABLE04 T");
            builder.append(" LEFT JOIN MULTI_TABLE05 T0 ON T.'MULTI_TABLE04_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected MultiTable04 loadCurrentDeep(Cursor cursor, boolean lock) {
        MultiTable04 entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        MultiTable05 multiTable05 = loadCurrentOther(daoSession.getMultiTable05Dao(), cursor, offset);
        entity.setMultiTable05(multiTable05);

        return entity;    
    }

    public MultiTable04 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<MultiTable04> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<MultiTable04> list = new ArrayList<MultiTable04>(count);
    ...
    protected List<MultiTable04> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<MultiTable04> queryDeep(String where, String... selectionArg) {
