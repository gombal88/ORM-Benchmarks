...
/**
 * Entity mapped to table MULTI_TABLE_07.
 */
public class MultiTable_07 {
    ...
    private Long MultiTable_08Id;

    /** Used to resolve relations */
    private transient DaoSession daoSession;

    /** Used for active entity operations. */
    private transient MultiTable_07Dao myDao;

    private MultiTable_08 multiTable_08;
    private Long multiTable_08__resolvedKey;
    ...
    public MultiTable_07(Long id, String SampleStringColl01, String SampleStringColl02, String SampleStringColl03, String SampleStringColl04, String SampleStringColl05, String SampleStringColl06, String SampleStringColl07, String SampleStringColl08, String SampleStringColl09, String SampleStringColl10, int SampleIntColl01, Integer SampleIntColl02, Double SampleRealColl01, Double SampleRealColl02, Integer SampleIntCollIndexed, Long MultiTable_08Id) {
        this.id = id;
        ...
        this.MultiTable_08Id = MultiTable_08Id;
    }

    /** called by internal mechanisms, do not call yourself. */
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getMultiTable_07Dao() : null;
    }
    ...
    public Long getMultiTable_08Id() {
        return MultiTable_08Id;
    }

    public void setMultiTable_08Id(Long MultiTable_08Id) {
        this.MultiTable_08Id = MultiTable_08Id;
    }

    /** To-one relationship, resolved on first access. */
    public MultiTable_08 getMultiTable_08() {
        Long __key = this.MultiTable_08Id;
        if (multiTable_08__resolvedKey == null || !multiTable_08__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            MultiTable_08Dao targetDao = daoSession.getMultiTable_08Dao();
            MultiTable_08 multiTable_08New = targetDao.load(__key);
            synchronized (this) {
                multiTable_08 = multiTable_08New;
            	multiTable_08__resolvedKey = __key;
            }
        }
    ...
    public void setMultiTable_08(MultiTable_08 multiTable_08) {
        synchronized (this) {
            ...
            MultiTable_08Id = multiTable_08 == null ? null : multiTable_08.getId();
            multiTable_08__resolvedKey = MultiTable_08Id;
        }
    }
