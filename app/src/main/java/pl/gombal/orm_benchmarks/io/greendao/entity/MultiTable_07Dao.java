...
/** 
 * DAO for table MULTI_TABLE_07.
*/
public class MultiTable_07Dao extends AbstractDao<MultiTable_07, Long> {

    public static final String TABLENAME = "MULTI_TABLE_07";

    /**
     * Properties of entity MultiTable_07.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property MultiTable_08Id = new Property(16, Long.class, "MultiTable_08Id", false, "MULTI_TABLE_08_ID");
    };

    private DaoSession daoSession;


    public MultiTable_07Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable_07Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE_07' (" + //
                ...
                "'MULTI_TABLE_08_ID' INTEGER);"); // 16: MultiTable_08Id
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE_07_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE_07" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE_07'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable_07 entity) {
        stmt.clearBindings();
        ...
        Long MultiTable_08Id = entity.getMultiTable_08Id();
        if (MultiTable_08Id != null) {
            stmt.bindLong(17, MultiTable_08Id);
        }
    }

    @Override
    protected void attachEntity(MultiTable_07 entity) {
    ...
    /** @inheritdoc */
    @Override
    public MultiTable_07 readEntity(Cursor cursor, int offset) {
        MultiTable_07 entity = new MultiTable_07( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // MultiTable_08Id
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable_07 entity, int offset) {
        ...
        entity.setMultiTable_08Id(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable_07 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable_07 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMultiTable_08Dao().getAllColumns());
            builder.append(" FROM MULTI_TABLE_07 T");
            builder.append(" LEFT JOIN MULTI_TABLE_08 T0 ON T.'MULTI_TABLE_08_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected MultiTable_07 loadCurrentDeep(Cursor cursor, boolean lock) {
        MultiTable_07 entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        MultiTable_08 multiTable_08 = loadCurrentOther(daoSession.getMultiTable_08Dao(), cursor, offset);
        entity.setMultiTable_08(multiTable_08);

        return entity;    
    }

    public MultiTable_07 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<MultiTable_07> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<MultiTable_07> list = new ArrayList<MultiTable_07>(count);
    ...
    protected List<MultiTable_07> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<MultiTable_07> queryDeep(String where, String... selectionArg) {
