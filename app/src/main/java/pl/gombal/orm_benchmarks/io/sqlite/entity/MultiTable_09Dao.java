...
public class MultiTable_09Dao extends BaseSampleDao<MultiTable_09> {
    ...
    public String getCreateTableStatement(boolean ifNotExists) {
        ...
        return "CREATE TABLE " + constraint + tableName + " ("
                ...
                + MULTI_TABLE_10_ID + " INTEGER, "
                + "FOREIGN KEY(" + MULTI_TABLE_10_ID + ") REFERENCES " + MultiTable_10Dao.TABLE_NAME + "(" + _ID + ") ON DELETE CASCADE ON UPDATE CASCADE);";
    }
    ...
    public String[] getCreateIndexStatements(boolean ifNotExists) {
        ...
        return new String[]{"CREATE INDEX " + constraint
                + "IDX_MULTI_TABLE_09_SAMPLE_INT_COLL_INDEXED ON "
    ...
    @Override
    protected long saveAction(SQLiteDatabase db, MultiTable_09 entity) {
        long nestedTableID = new MultiTable_10Dao().saveAction(db, entity.getMultiTable_10());
        entity.getMultiTable_10().setId(nestedTableID);
    ...
    protected int updateAction(SQLiteDatabase db, MultiTable_09 entity, String selection, String[] selectionArgs) {
        new MultiTable_10Dao().updateAction(db, entity.getMultiTable_10(), BaseColumns._ID + " = ? ", new String[]{String.valueOf(entity.getMultiTable_10().getId())});
