...
/** 
 * DAO for table MULTI_TABLE_01.
*/
public class MultiTable_01Dao extends AbstractDao<MultiTable_01, Long> {

    public static final String TABLENAME = "MULTI_TABLE_01";

    /**
     * Properties of entity MultiTable_01.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property MultiTable_02Id = new Property(16, Long.class, "MultiTable_02Id", false, "MULTI_TABLE_02_ID");
    };

    private DaoSession daoSession;


    public MultiTable_01Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable_01Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE_01' (" + //
                ...
                "'MULTI_TABLE_02_ID' INTEGER);"); // 16: MultiTable_02Id
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE_01_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE_01" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE_01'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable_01 entity) {
        stmt.clearBindings();
        ...
        Long MultiTable_02Id = entity.getMultiTable_02Id();
        if (MultiTable_02Id != null) {
            stmt.bindLong(17, MultiTable_02Id);
        }
    }

    @Override
    protected void attachEntity(MultiTable_01 entity) {
    ...
    /** @inheritdoc */
    @Override
    public MultiTable_01 readEntity(Cursor cursor, int offset) {
        MultiTable_01 entity = new MultiTable_01( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // MultiTable_02Id
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable_01 entity, int offset) {
        ...
        entity.setMultiTable_02Id(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable_01 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable_01 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMultiTable_02Dao().getAllColumns());
            builder.append(" FROM MULTI_TABLE_01 T");
            builder.append(" LEFT JOIN MULTI_TABLE_02 T0 ON T.'MULTI_TABLE_02_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected MultiTable_01 loadCurrentDeep(Cursor cursor, boolean lock) {
        MultiTable_01 entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        MultiTable_02 multiTable_02 = loadCurrentOther(daoSession.getMultiTable_02Dao(), cursor, offset);
        entity.setMultiTable_02(multiTable_02);

        return entity;    
    }

    public MultiTable_01 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<MultiTable_01> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<MultiTable_01> list = new ArrayList<MultiTable_01>(count);
    ...
    protected List<MultiTable_01> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<MultiTable_01> queryDeep(String where, String... selectionArg) {
