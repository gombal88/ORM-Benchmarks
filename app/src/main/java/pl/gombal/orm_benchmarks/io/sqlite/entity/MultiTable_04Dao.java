...
public class MultiTable_04Dao extends BaseSampleDao<MultiTable_04> {
    ...
    public String getCreateTableStatement(boolean ifNotExists) {
        ...
        return "CREATE TABLE " + constraint + tableName + " ("
                ...
                + MULTI_TABLE_05_ID + " INTEGER, "
                + "FOREIGN KEY(" + MULTI_TABLE_05_ID + ") REFERENCES " + MultiTable_05Dao.TABLE_NAME + "(" + _ID + ") ON DELETE CASCADE ON UPDATE CASCADE);";
    }
    ...
    public String[] getCreateIndexStatements(boolean ifNotExists) {
        ...
        return new String[]{"CREATE INDEX " + constraint
                + "IDX_MULTI_TABLE_04_SAMPLE_INT_COLL_INDEXED ON "
    ...
    @Override
    protected long saveAction(SQLiteDatabase db, MultiTable_04 entity) {
        long nestedTableID = new MultiTable_05Dao().saveAction(db, entity.getMultiTable_05());
        entity.getMultiTable_05().setId(nestedTableID);
    ...
    @Override
    protected int updateAction(SQLiteDatabase db, MultiTable_04 entity, String selection, String[] selectionArgs) {
        new MultiTable_05Dao().updateAction(db, entity.getMultiTable_05(), BaseColumns._ID + " = ? ", new String[]{String.valueOf(entity.getMultiTable_05().getId())});
