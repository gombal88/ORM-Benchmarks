...
/** 
 * DAO for table MULTI_TABLE03.
*/
public class MultiTable03Dao extends AbstractDao<MultiTable03, Long> {

    public static final String TABLENAME = "MULTI_TABLE03";

    /**
     * Properties of entity MultiTable03.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property MultiTable03Id = new Property(16, Long.class, "MultiTable03Id", false, "MULTI_TABLE03_ID");
    };

    private DaoSession daoSession;


    public MultiTable03Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable03Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE03' (" + //
                ...
                "'MULTI_TABLE03_ID' INTEGER);"); // 16: MultiTable03Id
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE03_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE03" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE03'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable03 entity) {
        stmt.clearBindings();
        ...
        Long MultiTable03Id = entity.getMultiTable03Id();
        if (MultiTable03Id != null) {
            stmt.bindLong(17, MultiTable03Id);
        }
    }

    @Override
    protected void attachEntity(MultiTable03 entity) {
    ...
    /** @inheritdoc */
    @Override
    public MultiTable03 readEntity(Cursor cursor, int offset) {
        MultiTable03 entity = new MultiTable03( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // MultiTable03Id
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable03 entity, int offset) {
        ...
        entity.setMultiTable03Id(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable03 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable03 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMultiTable04Dao().getAllColumns());
            builder.append(" FROM MULTI_TABLE03 T");
            builder.append(" LEFT JOIN MULTI_TABLE04 T0 ON T.'MULTI_TABLE03_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected MultiTable03 loadCurrentDeep(Cursor cursor, boolean lock) {
        MultiTable03 entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        MultiTable04 multiTable04 = loadCurrentOther(daoSession.getMultiTable04Dao(), cursor, offset);
        entity.setMultiTable04(multiTable04);

        return entity;    
    }

    public MultiTable03 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<MultiTable03> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<MultiTable03> list = new ArrayList<MultiTable03>(count);
    ...
    protected List<MultiTable03> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<MultiTable03> queryDeep(String where, String... selectionArg) {
