...
public class TableWithRelationToOneDao extends AbstractDao<TableWithRelationToOne, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property TableWithRelationToOneId = new Property(16, long.class, "TableWithRelationToOneId", false, "TABLE_WITH_RELATION_TO_ONE_ID");
        public final static Property TableWithRelationToManyId = new Property(17, Long.class, "TableWithRelationToManyId", false, "TABLE_WITH_RELATION_TO_MANY_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'TABLE_WITH_RELATION_TO_ONE' (" + //
                ...
                "'TABLE_WITH_RELATION_TO_ONE_ID' INTEGER NOT NULL ," + // 16: TableWithRelationToOneId
                "'TABLE_WITH_RELATION_TO_MANY_ID' INTEGER);"); // 17: TableWithRelationToManyId
        // Add Indexes
    ...
    protected void bindValues(SQLiteStatement stmt, TableWithRelationToOne entity) {
        ...
        stmt.bindLong(17, entity.getTableWithRelationToOneId());
 
        Long TableWithRelationToManyId = entity.getTableWithRelationToManyId();
        if (TableWithRelationToManyId != null) {
            stmt.bindLong(18, TableWithRelationToManyId);
        }
    }
    ...
    public TableWithRelationToOne readEntity(Cursor cursor, int offset) {
        TableWithRelationToOne entity = new TableWithRelationToOne( //
            ...
            cursor.getLong(offset + 16), // TableWithRelationToOneId
            cursor.isNull(offset + 17) ? null : cursor.getLong(offset + 17) // TableWithRelationToManyId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TableWithRelationToOne entity, int offset) {
        ...
        entity.setTableWithRelationToOneId(cursor.getLong(offset + 16));
        entity.setTableWithRelationToManyId(cursor.isNull(offset + 17) ? null : cursor.getLong(offset + 17));
     }
    ...
    public List<TableWithRelationToOne> _queryTableWithRelationToMany_TableWithRelationToOneList(long TableWithRelationToOneId) {
        synchronized (this) {
            if (tableWithRelationToMany_TableWithRelationToOneListQuery == null) {
                ...
                queryBuilder.where(Properties.TableWithRelationToOneId.eq(null));
        ...
        query.setParameter(0, TableWithRelationToOneId);
        return query.list();
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN TABLE_WITH_RELATION_TO_MANY T0 ON T.'TABLE_WITH_RELATION_TO_MANY_ID'=T0.'_id'");
            builder.append(' ');
