...
/** 
 * DAO for table MULTI_TABLE10.
*/
public class MultiTable10Dao extends AbstractDao<MultiTable10, Long> {

    public static final String TABLENAME = "MULTI_TABLE10";

    /**
     * Properties of entity MultiTable10.<br/>
    ...
    */
    ...
    public MultiTable10Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable10Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE10' (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE10_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE10" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE10'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable10 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MultiTable10 readEntity(Cursor cursor, int offset) {
        MultiTable10 entity = new MultiTable10( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable10 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable10 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable10 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
