...
/** 
 * DAO for table TABLE_WITH_RELATION_TO_MANY.
*/
public class TableWithRelationToManyDao extends AbstractDao<TableWithRelationToMany, Long> {

    public static final String TABLENAME = "TABLE_WITH_RELATION_TO_MANY";

    /**
     * Properties of entity TableWithRelationToMany.<br/>
    ...
    */
    ...
    public TableWithRelationToManyDao(DaoConfig config) {
        super(config);
    }
    
    public TableWithRelationToManyDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'TABLE_WITH_RELATION_TO_MANY' (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_TABLE_WITH_RELATION_TO_MANY_SAMPLE_INT_COLL_INDEXED ON TABLE_WITH_RELATION_TO_MANY" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'TABLE_WITH_RELATION_TO_MANY'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TableWithRelationToMany entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(TableWithRelationToMany entity) {
    ...
    /** @inheritdoc */
    @Override
    public TableWithRelationToMany readEntity(Cursor cursor, int offset) {
        TableWithRelationToMany entity = new TableWithRelationToMany( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, TableWithRelationToMany entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(TableWithRelationToMany entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(TableWithRelationToMany entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
