...
/**
 * Entity mapped to table MULTI_TABLE06.
 */
public class MultiTable06 {
    ...
    private Long MultiTable06Id;

    /** Used to resolve relations */
    private transient DaoSession daoSession;

    /** Used for active entity operations. */
    private transient MultiTable06Dao myDao;

    private MultiTable07 multiTable07;
    private Long multiTable07__resolvedKey;


    public MultiTable06() {
    }

    public MultiTable06(Long id) {
        this.id = id;
    }

    public MultiTable06(Long id, short SampleStringColl01, Short SampleStringColl02, Short SampleStringColl03, Short SampleStringColl04, Short SampleStringColl05, Short SampleStringColl06, Short SampleStringColl07, Short SampleStringColl08, Short SampleStringColl09, Short SampleStringColl10, int SampleIntColl01, Integer SampleIntColl02, Double SampleRealColl01, Double SampleRealColl02, Integer SampleIntCollIndexed, Long MultiTable06Id) {
        this.id = id;
        ...
        this.MultiTable06Id = MultiTable06Id;
    }

    /** called by internal mechanisms, do not call yourself. */
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getMultiTable06Dao() : null;
    }
    ...
    public Long getMultiTable06Id() {
        return MultiTable06Id;
    }

    public void setMultiTable06Id(Long MultiTable06Id) {
        this.MultiTable06Id = MultiTable06Id;
    }

    /** To-one relationship, resolved on first access. */
    public MultiTable07 getMultiTable07() {
        Long __key = this.MultiTable06Id;
        if (multiTable07__resolvedKey == null || !multiTable07__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            MultiTable07Dao targetDao = daoSession.getMultiTable07Dao();
            MultiTable07 multiTable07New = targetDao.load(__key);
            synchronized (this) {
                multiTable07 = multiTable07New;
            	multiTable07__resolvedKey = __key;
            }
        }
        return multiTable07;
    }

    public void setMultiTable07(MultiTable07 multiTable07) {
        synchronized (this) {
            this.multiTable07 = multiTable07;
            MultiTable06Id = multiTable07 == null ? null : multiTable07.getId();
            multiTable07__resolvedKey = MultiTable06Id;
        }
    }
