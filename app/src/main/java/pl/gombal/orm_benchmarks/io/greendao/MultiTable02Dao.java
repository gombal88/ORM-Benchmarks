...
/** 
 * DAO for table MULTI_TABLE02.
*/
public class MultiTable02Dao extends AbstractDao<MultiTable02, Long> {

    public static final String TABLENAME = "MULTI_TABLE02";

    /**
     * Properties of entity MultiTable02.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property MultiTable02Id = new Property(16, Long.class, "MultiTable02Id", false, "MULTI_TABLE02_ID");
    };

    private DaoSession daoSession;


    public MultiTable02Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable02Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE02' (" + //
                ...
                "'MULTI_TABLE02_ID' INTEGER);"); // 16: MultiTable02Id
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE02_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE02" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE02'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable02 entity) {
        stmt.clearBindings();
        ...
        Long MultiTable02Id = entity.getMultiTable02Id();
        if (MultiTable02Id != null) {
            stmt.bindLong(17, MultiTable02Id);
        }
    }

    @Override
    protected void attachEntity(MultiTable02 entity) {
    ...
    /** @inheritdoc */
    @Override
    public MultiTable02 readEntity(Cursor cursor, int offset) {
        MultiTable02 entity = new MultiTable02( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // MultiTable02Id
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable02 entity, int offset) {
        ...
        entity.setMultiTable02Id(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable02 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable02 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMultiTable03Dao().getAllColumns());
            builder.append(" FROM MULTI_TABLE02 T");
            builder.append(" LEFT JOIN MULTI_TABLE03 T0 ON T.'MULTI_TABLE02_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected MultiTable02 loadCurrentDeep(Cursor cursor, boolean lock) {
        MultiTable02 entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        MultiTable03 multiTable03 = loadCurrentOther(daoSession.getMultiTable03Dao(), cursor, offset);
        entity.setMultiTable03(multiTable03);

        return entity;    
    }

    public MultiTable02 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<MultiTable02> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<MultiTable02> list = new ArrayList<MultiTable02>(count);
    ...
    protected List<MultiTable02> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<MultiTable02> queryDeep(String where, String... selectionArg) {
