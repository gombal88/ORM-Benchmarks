...
/**
 * Entity mapped to table MULTI_TABLE_06.
 */
public class MultiTable_06 {
    ...
    private Long MultiTable_07Id;

    /** Used to resolve relations */
    private transient DaoSession daoSession;

    /** Used for active entity operations. */
    private transient MultiTable_06Dao myDao;

    private MultiTable_07 multiTable_07;
    private Long multiTable_07__resolvedKey;
    ...
    public MultiTable_06(Long id, String SampleStringColl01, String SampleStringColl02, String SampleStringColl03, String SampleStringColl04, String SampleStringColl05, String SampleStringColl06, String SampleStringColl07, String SampleStringColl08, String SampleStringColl09, String SampleStringColl10, int SampleIntColl01, Integer SampleIntColl02, Double SampleRealColl01, Double SampleRealColl02, Integer SampleIntCollIndexed, Long MultiTable_07Id) {
        this.id = id;
        ...
        this.MultiTable_07Id = MultiTable_07Id;
    }

    /** called by internal mechanisms, do not call yourself. */
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getMultiTable_06Dao() : null;
    }
    ...
    public Long getMultiTable_07Id() {
        return MultiTable_07Id;
    }

    public void setMultiTable_07Id(Long MultiTable_07Id) {
        this.MultiTable_07Id = MultiTable_07Id;
    }

    /** To-one relationship, resolved on first access. */
    public MultiTable_07 getMultiTable_07() {
        Long __key = this.MultiTable_07Id;
        if (multiTable_07__resolvedKey == null || !multiTable_07__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            MultiTable_07Dao targetDao = daoSession.getMultiTable_07Dao();
            MultiTable_07 multiTable_07New = targetDao.load(__key);
            synchronized (this) {
                multiTable_07 = multiTable_07New;
            	multiTable_07__resolvedKey = __key;
            }
        }
    ...
    public void setMultiTable_07(MultiTable_07 multiTable_07) {
        synchronized (this) {
            ...
            MultiTable_07Id = multiTable_07 == null ? null : multiTable_07.getId();
            multiTable_07__resolvedKey = MultiTable_07Id;
        }
    }
