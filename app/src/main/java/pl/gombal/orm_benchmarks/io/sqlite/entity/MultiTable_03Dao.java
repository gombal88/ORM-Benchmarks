...
public class MultiTable_03Dao extends BaseSampleDao<MultiTable_03> {
    ...
    public String getCreateTableStatement(boolean ifNotExists) {
        ...
        return "CREATE TABLE " + constraint + tableName + " ("
                ...
                + MULTI_TABLE_04_ID + " INTEGER, "
                + "FOREIGN KEY(" + MULTI_TABLE_04_ID + ") REFERENCES " + MultiTable_04Dao.TABLE_NAME + "(" + _ID + ") ON DELETE CASCADE ON UPDATE CASCADE);";
    }
    ...
    public String[] getCreateIndexStatements(boolean ifNotExists) {
        ...
        return new String[]{"CREATE INDEX " + constraint
                + "IDX_MULTI_TABLE_03_SAMPLE_INT_COLL_INDEXED ON "
    ...
    protected long saveAction(SQLiteDatabase db, MultiTable_03 entity) {
        long nestedTableID = new MultiTable_04Dao().saveAction(db, entity.getMultiTable_04());
        entity.getMultiTable_04().setId(nestedTableID);
    ...
    @Override
    protected int updateAction(SQLiteDatabase db, MultiTable_03 entity, String selection, String[] selectionArgs) {
        new MultiTable_04Dao().updateAction(db, entity.getMultiTable_04(), BaseColumns._ID + " = ? ", new String[]{String.valueOf(entity.getMultiTable_04().getId())});
