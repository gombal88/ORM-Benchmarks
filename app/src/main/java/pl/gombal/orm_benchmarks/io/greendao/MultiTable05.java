...
/**
 * Entity mapped to table MULTI_TABLE05.
 */
public class MultiTable05 {
    ...
    private Long MultiTable05Id;

    /** Used to resolve relations */
    private transient DaoSession daoSession;

    /** Used for active entity operations. */
    private transient MultiTable05Dao myDao;

    private MultiTable06 multiTable06;
    private Long multiTable06__resolvedKey;


    public MultiTable05() {
    }

    public MultiTable05(Long id) {
        this.id = id;
    }

    public MultiTable05(Long id, short SampleStringColl01, Short SampleStringColl02, Short SampleStringColl03, Short SampleStringColl04, Short SampleStringColl05, Short SampleStringColl06, Short SampleStringColl07, Short SampleStringColl08, Short SampleStringColl09, Short SampleStringColl10, int SampleIntColl01, Integer SampleIntColl02, Double SampleRealColl01, Double SampleRealColl02, Integer SampleIntCollIndexed, Long MultiTable05Id) {
        this.id = id;
        ...
        this.MultiTable05Id = MultiTable05Id;
    }

    /** called by internal mechanisms, do not call yourself. */
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getMultiTable05Dao() : null;
    }
    ...
    public Long getMultiTable05Id() {
        return MultiTable05Id;
    }

    public void setMultiTable05Id(Long MultiTable05Id) {
        this.MultiTable05Id = MultiTable05Id;
    }

    /** To-one relationship, resolved on first access. */
    public MultiTable06 getMultiTable06() {
        Long __key = this.MultiTable05Id;
        if (multiTable06__resolvedKey == null || !multiTable06__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            MultiTable06Dao targetDao = daoSession.getMultiTable06Dao();
            MultiTable06 multiTable06New = targetDao.load(__key);
            synchronized (this) {
                multiTable06 = multiTable06New;
            	multiTable06__resolvedKey = __key;
            }
        }
        return multiTable06;
    }

    public void setMultiTable06(MultiTable06 multiTable06) {
        synchronized (this) {
            this.multiTable06 = multiTable06;
            MultiTable05Id = multiTable06 == null ? null : multiTable06.getId();
            multiTable06__resolvedKey = MultiTable05Id;
        }
    }
