...
/**
 * Entity mapped to table MULTI_TABLE07.
 */
public class MultiTable07 {
    ...
    private Long MultiTable07Id;

    /** Used to resolve relations */
    private transient DaoSession daoSession;

    /** Used for active entity operations. */
    private transient MultiTable07Dao myDao;

    private MultiTable08 multiTable08;
    private Long multiTable08__resolvedKey;


    public MultiTable07() {
    }

    public MultiTable07(Long id) {
        this.id = id;
    }

    public MultiTable07(Long id, short SampleStringColl01, Short SampleStringColl02, Short SampleStringColl03, Short SampleStringColl04, Short SampleStringColl05, Short SampleStringColl06, Short SampleStringColl07, Short SampleStringColl08, Short SampleStringColl09, Short SampleStringColl10, int SampleIntColl01, Integer SampleIntColl02, Double SampleRealColl01, Double SampleRealColl02, Integer SampleIntCollIndexed, Long MultiTable07Id) {
        this.id = id;
        ...
        this.MultiTable07Id = MultiTable07Id;
    }

    /** called by internal mechanisms, do not call yourself. */
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getMultiTable07Dao() : null;
    }
    ...
    public Long getMultiTable07Id() {
        return MultiTable07Id;
    }

    public void setMultiTable07Id(Long MultiTable07Id) {
        this.MultiTable07Id = MultiTable07Id;
    }

    /** To-one relationship, resolved on first access. */
    public MultiTable08 getMultiTable08() {
        Long __key = this.MultiTable07Id;
        if (multiTable08__resolvedKey == null || !multiTable08__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            MultiTable08Dao targetDao = daoSession.getMultiTable08Dao();
            MultiTable08 multiTable08New = targetDao.load(__key);
            synchronized (this) {
                multiTable08 = multiTable08New;
            	multiTable08__resolvedKey = __key;
            }
        }
        return multiTable08;
    }

    public void setMultiTable08(MultiTable08 multiTable08) {
        synchronized (this) {
            this.multiTable08 = multiTable08;
            MultiTable07Id = multiTable08 == null ? null : multiTable08.getId();
            multiTable08__resolvedKey = MultiTable07Id;
        }
    }
