...
/**
 * Entity mapped to table MULTI_TABLE02.
 */
public class MultiTable02 {
    ...
    private Long MultiTable02Id;

    /** Used to resolve relations */
    private transient DaoSession daoSession;

    /** Used for active entity operations. */
    private transient MultiTable02Dao myDao;

    private MultiTable03 multiTable03;
    private Long multiTable03__resolvedKey;


    public MultiTable02() {
    }

    public MultiTable02(Long id) {
        this.id = id;
    }

    public MultiTable02(Long id, short SampleStringColl01, Short SampleStringColl02, Short SampleStringColl03, Short SampleStringColl04, Short SampleStringColl05, Short SampleStringColl06, Short SampleStringColl07, Short SampleStringColl08, Short SampleStringColl09, Short SampleStringColl10, int SampleIntColl01, Integer SampleIntColl02, Double SampleRealColl01, Double SampleRealColl02, Integer SampleIntCollIndexed, Long MultiTable02Id) {
        this.id = id;
        ...
        this.MultiTable02Id = MultiTable02Id;
    }

    /** called by internal mechanisms, do not call yourself. */
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getMultiTable02Dao() : null;
    }
    ...
    public Long getMultiTable02Id() {
        return MultiTable02Id;
    }

    public void setMultiTable02Id(Long MultiTable02Id) {
        this.MultiTable02Id = MultiTable02Id;
    }

    /** To-one relationship, resolved on first access. */
    public MultiTable03 getMultiTable03() {
        Long __key = this.MultiTable02Id;
        if (multiTable03__resolvedKey == null || !multiTable03__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            MultiTable03Dao targetDao = daoSession.getMultiTable03Dao();
            MultiTable03 multiTable03New = targetDao.load(__key);
            synchronized (this) {
                multiTable03 = multiTable03New;
            	multiTable03__resolvedKey = __key;
            }
        }
        return multiTable03;
    }

    public void setMultiTable03(MultiTable03 multiTable03) {
        synchronized (this) {
            this.multiTable03 = multiTable03;
            MultiTable02Id = multiTable03 == null ? null : multiTable03.getId();
            multiTable03__resolvedKey = MultiTable02Id;
        }
    }
