...
/**
 * Entity mapped to table MULTI_TABLE_05.
 */
public class MultiTable_05 {
    ...
    private Long MultiTable_06Id;

    /** Used to resolve relations */
    private transient DaoSession daoSession;

    /** Used for active entity operations. */
    private transient MultiTable_05Dao myDao;

    private MultiTable_06 multiTable_06;
    private Long multiTable_06__resolvedKey;
    ...
    public MultiTable_05(Long id, String SampleStringColl01, String SampleStringColl02, String SampleStringColl03, String SampleStringColl04, String SampleStringColl05, String SampleStringColl06, String SampleStringColl07, String SampleStringColl08, String SampleStringColl09, String SampleStringColl10, int SampleIntColl01, Integer SampleIntColl02, Double SampleRealColl01, Double SampleRealColl02, Integer SampleIntCollIndexed, Long MultiTable_06Id) {
        this.id = id;
        ...
        this.MultiTable_06Id = MultiTable_06Id;
    }

    /** called by internal mechanisms, do not call yourself. */
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getMultiTable_05Dao() : null;
    }
    ...
    public Long getMultiTable_06Id() {
        return MultiTable_06Id;
    }

    public void setMultiTable_06Id(Long MultiTable_06Id) {
        this.MultiTable_06Id = MultiTable_06Id;
    }

    /** To-one relationship, resolved on first access. */
    public MultiTable_06 getMultiTable_06() {
        Long __key = this.MultiTable_06Id;
        if (multiTable_06__resolvedKey == null || !multiTable_06__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            MultiTable_06Dao targetDao = daoSession.getMultiTable_06Dao();
            MultiTable_06 multiTable_06New = targetDao.load(__key);
            synchronized (this) {
                multiTable_06 = multiTable_06New;
            	multiTable_06__resolvedKey = __key;
            }
        }
    ...
    public void setMultiTable_06(MultiTable_06 multiTable_06) {
        synchronized (this) {
            ...
            MultiTable_06Id = multiTable_06 == null ? null : multiTable_06.getId();
            multiTable_06__resolvedKey = MultiTable_06Id;
        }
    }
