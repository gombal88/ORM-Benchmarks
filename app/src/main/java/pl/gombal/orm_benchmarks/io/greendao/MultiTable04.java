...
/**
 * Entity mapped to table MULTI_TABLE04.
 */
public class MultiTable04 {
    ...
    private Long MultiTable04Id;

    /** Used to resolve relations */
    private transient DaoSession daoSession;

    /** Used for active entity operations. */
    private transient MultiTable04Dao myDao;

    private MultiTable05 multiTable05;
    private Long multiTable05__resolvedKey;


    public MultiTable04() {
    }

    public MultiTable04(Long id) {
        this.id = id;
    }

    public MultiTable04(Long id, short SampleStringColl01, Short SampleStringColl02, Short SampleStringColl03, Short SampleStringColl04, Short SampleStringColl05, Short SampleStringColl06, Short SampleStringColl07, Short SampleStringColl08, Short SampleStringColl09, Short SampleStringColl10, int SampleIntColl01, Integer SampleIntColl02, Double SampleRealColl01, Double SampleRealColl02, Integer SampleIntCollIndexed, Long MultiTable04Id) {
        this.id = id;
        ...
        this.MultiTable04Id = MultiTable04Id;
    }

    /** called by internal mechanisms, do not call yourself. */
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getMultiTable04Dao() : null;
    }
    ...
    public Long getMultiTable04Id() {
        return MultiTable04Id;
    }

    public void setMultiTable04Id(Long MultiTable04Id) {
        this.MultiTable04Id = MultiTable04Id;
    }

    /** To-one relationship, resolved on first access. */
    public MultiTable05 getMultiTable05() {
        Long __key = this.MultiTable04Id;
        if (multiTable05__resolvedKey == null || !multiTable05__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            MultiTable05Dao targetDao = daoSession.getMultiTable05Dao();
            MultiTable05 multiTable05New = targetDao.load(__key);
            synchronized (this) {
                multiTable05 = multiTable05New;
            	multiTable05__resolvedKey = __key;
            }
        }
        return multiTable05;
    }

    public void setMultiTable05(MultiTable05 multiTable05) {
        synchronized (this) {
            this.multiTable05 = multiTable05;
            MultiTable04Id = multiTable05 == null ? null : multiTable05.getId();
            multiTable05__resolvedKey = MultiTable04Id;
        }
    }
