...
public abstract class BaseSampleEntity extends BaseEntity {
    ...
    public ContentValues getContentValues() {
        ...
        values.put(BaseSampleDao.SAMPLE_STRING_COLL_01, SampleStringColl01);
        values.put(BaseSampleDao.SAMPLE_STRING_COLL_02, SampleStringColl02);
        values.put(BaseSampleDao.SAMPLE_STRING_COLL_03, SampleStringColl03);
        values.put(BaseSampleDao.SAMPLE_STRING_COLL_04, SampleStringColl04);
        values.put(BaseSampleDao.SAMPLE_STRING_COLL_05, SampleStringColl05);
        values.put(BaseSampleDao.SAMPLE_STRING_COLL_06, SampleStringColl06);
        values.put(BaseSampleDao.SAMPLE_STRING_COLL_07, SampleStringColl07);
        values.put(BaseSampleDao.SAMPLE_STRING_COLL_08, SampleStringColl08);
        values.put(BaseSampleDao.SAMPLE_STRING_COLL_09, SampleStringColl09);
        values.put(BaseSampleDao.SAMPLE_STRING_COLL_10, SampleStringColl10);
        values.put(BaseSampleDao.SAMPLE_INT_COLL_01, SampleIntColl01);
        values.put(BaseSampleDao.SAMPLE_INT_COLL_02, SampleIntColl02);
        values.put(BaseSampleDao.SAMPLE_REAL_COLL_01, SampleRealColl01);
        values.put(BaseSampleDao.SAMPLE_REAL_COLL_02, SampleRealColl02);
        values.put(BaseSampleDao.SAMPLE_INT_COLL_INDEXED, SampleIntCollIndexed);
