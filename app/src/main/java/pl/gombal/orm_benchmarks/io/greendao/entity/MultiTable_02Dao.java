...
/** 
 * DAO for table MULTI_TABLE_02.
*/
public class MultiTable_02Dao extends AbstractDao<MultiTable_02, Long> {

    public static final String TABLENAME = "MULTI_TABLE_02";

    /**
     * Properties of entity MultiTable_02.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property MultiTable_03Id = new Property(16, Long.class, "MultiTable_03Id", false, "MULTI_TABLE_03_ID");
    };

    private DaoSession daoSession;


    public MultiTable_02Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable_02Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE_02' (" + //
                ...
                "'MULTI_TABLE_03_ID' INTEGER);"); // 16: MultiTable_03Id
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE_02_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE_02" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE_02'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable_02 entity) {
        stmt.clearBindings();
        ...
        Long MultiTable_03Id = entity.getMultiTable_03Id();
        if (MultiTable_03Id != null) {
            stmt.bindLong(17, MultiTable_03Id);
        }
    }

    @Override
    protected void attachEntity(MultiTable_02 entity) {
    ...
    /** @inheritdoc */
    @Override
    public MultiTable_02 readEntity(Cursor cursor, int offset) {
        MultiTable_02 entity = new MultiTable_02( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // MultiTable_03Id
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable_02 entity, int offset) {
        ...
        entity.setMultiTable_03Id(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable_02 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable_02 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMultiTable_03Dao().getAllColumns());
            builder.append(" FROM MULTI_TABLE_02 T");
            builder.append(" LEFT JOIN MULTI_TABLE_03 T0 ON T.'MULTI_TABLE_03_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected MultiTable_02 loadCurrentDeep(Cursor cursor, boolean lock) {
        MultiTable_02 entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        MultiTable_03 multiTable_03 = loadCurrentOther(daoSession.getMultiTable_03Dao(), cursor, offset);
        entity.setMultiTable_03(multiTable_03);

        return entity;    
    }

    public MultiTable_02 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<MultiTable_02> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<MultiTable_02> list = new ArrayList<MultiTable_02>(count);
    ...
    protected List<MultiTable_02> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<MultiTable_02> queryDeep(String where, String... selectionArg) {
