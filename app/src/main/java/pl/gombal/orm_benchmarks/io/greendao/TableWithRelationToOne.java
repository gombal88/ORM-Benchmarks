...
public class TableWithRelationToOne {
    ...
    public TableWithRelationToOne(Long id, short SampleStringColl01, Short SampleStringColl02, Short SampleStringColl03, Short SampleStringColl04, Short SampleStringColl05, Short SampleStringColl06, Short SampleStringColl07, Short SampleStringColl08, Short SampleStringColl09, Short SampleStringColl10, int SampleIntColl01, Integer SampleIntColl02, Double SampleRealColl01, Double SampleRealColl02, Integer SampleIntCollIndexed, long TableWithRelationToManyId, Long TableWithRelationToOneId) {
        this.id = id;
    ...
    public TableWithRelationToMany getTableWithRelationToMany() {
        Long __key = this.TableWithRelationToOneId;
    ...
    public void setTableWithRelationToMany(TableWithRelationToMany tableWithRelationToMany) {
        synchronized (this) {
            ...
            TableWithRelationToOneId = tableWithRelationToMany == null ? null : tableWithRelationToMany.getId();
            tableWithRelationToMany__resolvedKey = TableWithRelationToOneId;
        }
    }
