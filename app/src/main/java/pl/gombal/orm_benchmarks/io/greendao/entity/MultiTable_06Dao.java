...
/** 
 * DAO for table MULTI_TABLE_06.
*/
public class MultiTable_06Dao extends AbstractDao<MultiTable_06, Long> {

    public static final String TABLENAME = "MULTI_TABLE_06";

    /**
     * Properties of entity MultiTable_06.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property MultiTable_07Id = new Property(16, Long.class, "MultiTable_07Id", false, "MULTI_TABLE_07_ID");
    };

    private DaoSession daoSession;


    public MultiTable_06Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable_06Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE_06' (" + //
                ...
                "'MULTI_TABLE_07_ID' INTEGER);"); // 16: MultiTable_07Id
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE_06_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE_06" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE_06'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable_06 entity) {
        stmt.clearBindings();
        ...
        Long MultiTable_07Id = entity.getMultiTable_07Id();
        if (MultiTable_07Id != null) {
            stmt.bindLong(17, MultiTable_07Id);
        }
    }

    @Override
    protected void attachEntity(MultiTable_06 entity) {
    ...
    /** @inheritdoc */
    @Override
    public MultiTable_06 readEntity(Cursor cursor, int offset) {
        MultiTable_06 entity = new MultiTable_06( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // MultiTable_07Id
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable_06 entity, int offset) {
        ...
        entity.setMultiTable_07Id(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable_06 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable_06 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMultiTable_07Dao().getAllColumns());
            builder.append(" FROM MULTI_TABLE_06 T");
            builder.append(" LEFT JOIN MULTI_TABLE_07 T0 ON T.'MULTI_TABLE_07_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected MultiTable_06 loadCurrentDeep(Cursor cursor, boolean lock) {
        MultiTable_06 entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        MultiTable_07 multiTable_07 = loadCurrentOther(daoSession.getMultiTable_07Dao(), cursor, offset);
        entity.setMultiTable_07(multiTable_07);

        return entity;    
    }

    public MultiTable_06 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<MultiTable_06> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<MultiTable_06> list = new ArrayList<MultiTable_06>(count);
    ...
    protected List<MultiTable_06> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<MultiTable_06> queryDeep(String where, String... selectionArg) {
