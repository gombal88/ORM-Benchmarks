...
/** 
 * DAO for table MULTI_TABLE05.
*/
public class MultiTable05Dao extends AbstractDao<MultiTable05, Long> {

    public static final String TABLENAME = "MULTI_TABLE05";

    /**
     * Properties of entity MultiTable05.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property MultiTable05Id = new Property(16, Long.class, "MultiTable05Id", false, "MULTI_TABLE05_ID");
    };

    private DaoSession daoSession;


    public MultiTable05Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable05Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE05' (" + //
                ...
                "'MULTI_TABLE05_ID' INTEGER);"); // 16: MultiTable05Id
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE05_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE05" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE05'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable05 entity) {
        stmt.clearBindings();
        ...
        Long MultiTable05Id = entity.getMultiTable05Id();
        if (MultiTable05Id != null) {
            stmt.bindLong(17, MultiTable05Id);
        }
    }

    @Override
    protected void attachEntity(MultiTable05 entity) {
    ...
    /** @inheritdoc */
    @Override
    public MultiTable05 readEntity(Cursor cursor, int offset) {
        MultiTable05 entity = new MultiTable05( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // MultiTable05Id
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable05 entity, int offset) {
        ...
        entity.setMultiTable05Id(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable05 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable05 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMultiTable06Dao().getAllColumns());
            builder.append(" FROM MULTI_TABLE05 T");
            builder.append(" LEFT JOIN MULTI_TABLE06 T0 ON T.'MULTI_TABLE05_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected MultiTable05 loadCurrentDeep(Cursor cursor, boolean lock) {
        MultiTable05 entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        MultiTable06 multiTable06 = loadCurrentOther(daoSession.getMultiTable06Dao(), cursor, offset);
        entity.setMultiTable06(multiTable06);

        return entity;    
    }

    public MultiTable05 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<MultiTable05> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<MultiTable05> list = new ArrayList<MultiTable05>(count);
    ...
    protected List<MultiTable05> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<MultiTable05> queryDeep(String where, String... selectionArg) {
