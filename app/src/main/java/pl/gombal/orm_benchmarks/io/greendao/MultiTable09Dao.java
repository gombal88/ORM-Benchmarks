...
/** 
 * DAO for table MULTI_TABLE09.
*/
public class MultiTable09Dao extends AbstractDao<MultiTable09, Long> {

    public static final String TABLENAME = "MULTI_TABLE09";

    /**
     * Properties of entity MultiTable09.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property MultiTable09Id = new Property(16, Long.class, "MultiTable09Id", false, "MULTI_TABLE09_ID");
    };

    private DaoSession daoSession;


    public MultiTable09Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable09Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE09' (" + //
                ...
                "'MULTI_TABLE09_ID' INTEGER);"); // 16: MultiTable09Id
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE09_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE09" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE09'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable09 entity) {
        stmt.clearBindings();
        ...
        Long MultiTable09Id = entity.getMultiTable09Id();
        if (MultiTable09Id != null) {
            stmt.bindLong(17, MultiTable09Id);
        }
    }

    @Override
    protected void attachEntity(MultiTable09 entity) {
    ...
    /** @inheritdoc */
    @Override
    public MultiTable09 readEntity(Cursor cursor, int offset) {
        MultiTable09 entity = new MultiTable09( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // MultiTable09Id
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable09 entity, int offset) {
        ...
        entity.setMultiTable09Id(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable09 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable09 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMultiTable10Dao().getAllColumns());
            builder.append(" FROM MULTI_TABLE09 T");
            builder.append(" LEFT JOIN MULTI_TABLE10 T0 ON T.'MULTI_TABLE09_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected MultiTable09 loadCurrentDeep(Cursor cursor, boolean lock) {
        MultiTable09 entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        MultiTable10 multiTable10 = loadCurrentOther(daoSession.getMultiTable10Dao(), cursor, offset);
        entity.setMultiTable10(multiTable10);

        return entity;    
    }

    public MultiTable09 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<MultiTable09> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<MultiTable09> list = new ArrayList<MultiTable09>(count);
    ...
    protected List<MultiTable09> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<MultiTable09> queryDeep(String where, String... selectionArg) {
