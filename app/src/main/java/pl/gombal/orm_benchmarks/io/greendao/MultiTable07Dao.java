...
/** 
 * DAO for table MULTI_TABLE07.
*/
public class MultiTable07Dao extends AbstractDao<MultiTable07, Long> {

    public static final String TABLENAME = "MULTI_TABLE07";

    /**
     * Properties of entity MultiTable07.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property MultiTable07Id = new Property(16, Long.class, "MultiTable07Id", false, "MULTI_TABLE07_ID");
    };

    private DaoSession daoSession;


    public MultiTable07Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable07Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE07' (" + //
                ...
                "'MULTI_TABLE07_ID' INTEGER);"); // 16: MultiTable07Id
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE07_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE07" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE07'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable07 entity) {
        stmt.clearBindings();
        ...
        Long MultiTable07Id = entity.getMultiTable07Id();
        if (MultiTable07Id != null) {
            stmt.bindLong(17, MultiTable07Id);
        }
    }

    @Override
    protected void attachEntity(MultiTable07 entity) {
    ...
    /** @inheritdoc */
    @Override
    public MultiTable07 readEntity(Cursor cursor, int offset) {
        MultiTable07 entity = new MultiTable07( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // MultiTable07Id
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable07 entity, int offset) {
        ...
        entity.setMultiTable07Id(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable07 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable07 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMultiTable08Dao().getAllColumns());
            builder.append(" FROM MULTI_TABLE07 T");
            builder.append(" LEFT JOIN MULTI_TABLE08 T0 ON T.'MULTI_TABLE07_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected MultiTable07 loadCurrentDeep(Cursor cursor, boolean lock) {
        MultiTable07 entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        MultiTable08 multiTable08 = loadCurrentOther(daoSession.getMultiTable08Dao(), cursor, offset);
        entity.setMultiTable08(multiTable08);

        return entity;    
    }

    public MultiTable07 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<MultiTable07> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<MultiTable07> list = new ArrayList<MultiTable07>(count);
    ...
    protected List<MultiTable07> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<MultiTable07> queryDeep(String where, String... selectionArg) {
