...
public class MultiTable_07Dao extends BaseSampleDao<MultiTable_07> {
    ...
    public String getCreateTableStatement(boolean ifNotExists) {
        ...
        return "CREATE TABLE " + constraint + tableName + " ("
                ...
                + MULTI_TABLE_08_ID + " INTEGER, "
                + "FOREIGN KEY(" + MULTI_TABLE_08_ID + ") REFERENCES " + MultiTable_08Dao.TABLE_NAME + "(" + _ID + ") ON DELETE CASCADE ON UPDATE CASCADE);";
    }
    ...
    public String[] getCreateIndexStatements(boolean ifNotExists) {
        ...
        return new String[]{"CREATE INDEX " + constraint
                + "IDX_MULTI_TABLE_07_SAMPLE_INT_COLL_INDEXED ON "
    ...
    @Override
    protected long saveAction(SQLiteDatabase db, MultiTable_07 entity) {
        long nestedTableID = new MultiTable_08Dao().saveAction(db, entity.getMultiTable_08());
        entity.getMultiTable_08().setId(nestedTableID);
    ...
    @Override
    protected int updateAction(SQLiteDatabase db, MultiTable_07 entity, String selection, String[] selectionArgs) {
        new MultiTable_08Dao().updateAction(db, entity.getMultiTable_08(), BaseColumns._ID + " = ? ", new String[]{String.valueOf(entity.getMultiTable_08().getId())});
