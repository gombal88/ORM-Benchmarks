...
/**
 * Entity mapped to table MULTI_TABLE_03.
 */
public class MultiTable_03 {
    ...
    private Long MultiTable_04Id;

    /** Used to resolve relations */
    private transient DaoSession daoSession;

    /** Used for active entity operations. */
    private transient MultiTable_03Dao myDao;

    private MultiTable_04 multiTable_04;
    private Long multiTable_04__resolvedKey;
    ...
    public MultiTable_03(Long id, String SampleStringColl01, String SampleStringColl02, String SampleStringColl03, String SampleStringColl04, String SampleStringColl05, String SampleStringColl06, String SampleStringColl07, String SampleStringColl08, String SampleStringColl09, String SampleStringColl10, int SampleIntColl01, Integer SampleIntColl02, Double SampleRealColl01, Double SampleRealColl02, Integer SampleIntCollIndexed, Long MultiTable_04Id) {
        this.id = id;
        ...
        this.MultiTable_04Id = MultiTable_04Id;
    }

    /** called by internal mechanisms, do not call yourself. */
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getMultiTable_03Dao() : null;
    }
    ...
    public Long getMultiTable_04Id() {
        return MultiTable_04Id;
    }

    public void setMultiTable_04Id(Long MultiTable_04Id) {
        this.MultiTable_04Id = MultiTable_04Id;
    }

    /** To-one relationship, resolved on first access. */
    public MultiTable_04 getMultiTable_04() {
        Long __key = this.MultiTable_04Id;
        if (multiTable_04__resolvedKey == null || !multiTable_04__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            MultiTable_04Dao targetDao = daoSession.getMultiTable_04Dao();
            MultiTable_04 multiTable_04New = targetDao.load(__key);
            synchronized (this) {
                multiTable_04 = multiTable_04New;
            	multiTable_04__resolvedKey = __key;
            }
        }
    ...
    public void setMultiTable_04(MultiTable_04 multiTable_04) {
        synchronized (this) {
            ...
            MultiTable_04Id = multiTable_04 == null ? null : multiTable_04.getId();
            multiTable_04__resolvedKey = MultiTable_04Id;
        }
    }
