...
/** 
 * DAO for table MULTI_TABLE_08.
*/
public class MultiTable_08Dao extends AbstractDao<MultiTable_08, Long> {

    public static final String TABLENAME = "MULTI_TABLE_08";

    /**
     * Properties of entity MultiTable_08.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property MultiTable_09Id = new Property(16, Long.class, "MultiTable_09Id", false, "MULTI_TABLE_09_ID");
    };

    private DaoSession daoSession;


    public MultiTable_08Dao(DaoConfig config) {
        super(config);
    }
    
    public MultiTable_08Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MULTI_TABLE_08' (" + //
                ...
                "'MULTI_TABLE_09_ID' INTEGER);"); // 16: MultiTable_09Id
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_MULTI_TABLE_08_SAMPLE_INT_COLL_INDEXED ON MULTI_TABLE_08" +
                " (SAMPLE_INT_COLL_INDEXED);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MULTI_TABLE_08'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MultiTable_08 entity) {
        stmt.clearBindings();
        ...
        Long MultiTable_09Id = entity.getMultiTable_09Id();
        if (MultiTable_09Id != null) {
            stmt.bindLong(17, MultiTable_09Id);
        }
    }

    @Override
    protected void attachEntity(MultiTable_08 entity) {
    ...
    /** @inheritdoc */
    @Override
    public MultiTable_08 readEntity(Cursor cursor, int offset) {
        MultiTable_08 entity = new MultiTable_08( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // MultiTable_09Id
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MultiTable_08 entity, int offset) {
        ...
        entity.setMultiTable_09Id(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MultiTable_08 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MultiTable_08 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMultiTable_09Dao().getAllColumns());
            builder.append(" FROM MULTI_TABLE_08 T");
            builder.append(" LEFT JOIN MULTI_TABLE_09 T0 ON T.'MULTI_TABLE_09_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected MultiTable_08 loadCurrentDeep(Cursor cursor, boolean lock) {
        MultiTable_08 entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        MultiTable_09 multiTable_09 = loadCurrentOther(daoSession.getMultiTable_09Dao(), cursor, offset);
        entity.setMultiTable_09(multiTable_09);

        return entity;    
    }

    public MultiTable_08 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<MultiTable_08> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<MultiTable_08> list = new ArrayList<MultiTable_08>(count);
    ...
    protected List<MultiTable_08> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<MultiTable_08> queryDeep(String where, String... selectionArg) {
