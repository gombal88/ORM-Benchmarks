...
/**
 * Entity mapped to table MULTI_TABLE_09.
 */
public class MultiTable_09 {
    ...
    private Long MultiTable_10Id;

    /** Used to resolve relations */
    private transient DaoSession daoSession;

    /** Used for active entity operations. */
    private transient MultiTable_09Dao myDao;

    private MultiTable_10 multiTable_10;
    private Long multiTable_10__resolvedKey;
    ...
    public MultiTable_09(Long id, String SampleStringColl01, String SampleStringColl02, String SampleStringColl03, String SampleStringColl04, String SampleStringColl05, String SampleStringColl06, String SampleStringColl07, String SampleStringColl08, String SampleStringColl09, String SampleStringColl10, int SampleIntColl01, Integer SampleIntColl02, Double SampleRealColl01, Double SampleRealColl02, Integer SampleIntCollIndexed, Long MultiTable_10Id) {
        this.id = id;
        ...
        this.MultiTable_10Id = MultiTable_10Id;
    }

    /** called by internal mechanisms, do not call yourself. */
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getMultiTable_09Dao() : null;
    }
    ...
    public Long getMultiTable_10Id() {
        return MultiTable_10Id;
    }

    public void setMultiTable_10Id(Long MultiTable_10Id) {
        this.MultiTable_10Id = MultiTable_10Id;
    }

    /** To-one relationship, resolved on first access. */
    public MultiTable_10 getMultiTable_10() {
        Long __key = this.MultiTable_10Id;
        if (multiTable_10__resolvedKey == null || !multiTable_10__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            MultiTable_10Dao targetDao = daoSession.getMultiTable_10Dao();
            MultiTable_10 multiTable_10New = targetDao.load(__key);
            synchronized (this) {
                multiTable_10 = multiTable_10New;
            	multiTable_10__resolvedKey = __key;
            }
        }
    ...
    public void setMultiTable_10(MultiTable_10 multiTable_10) {
        synchronized (this) {
            ...
            MultiTable_10Id = multiTable_10 == null ? null : multiTable_10.getId();
            multiTable_10__resolvedKey = MultiTable_10Id;
        }
    }
