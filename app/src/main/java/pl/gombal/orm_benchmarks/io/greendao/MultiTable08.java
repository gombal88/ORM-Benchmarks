...
/**
 * Entity mapped to table MULTI_TABLE08.
 */
public class MultiTable08 {
    ...
    private Long MultiTable08Id;

    /** Used to resolve relations */
    private transient DaoSession daoSession;

    /** Used for active entity operations. */
    private transient MultiTable08Dao myDao;

    private MultiTable09 multiTable09;
    private Long multiTable09__resolvedKey;


    public MultiTable08() {
    }

    public MultiTable08(Long id) {
        this.id = id;
    }

    public MultiTable08(Long id, short SampleStringColl01, Short SampleStringColl02, Short SampleStringColl03, Short SampleStringColl04, Short SampleStringColl05, Short SampleStringColl06, Short SampleStringColl07, Short SampleStringColl08, Short SampleStringColl09, Short SampleStringColl10, int SampleIntColl01, Integer SampleIntColl02, Double SampleRealColl01, Double SampleRealColl02, Integer SampleIntCollIndexed, Long MultiTable08Id) {
        this.id = id;
        ...
        this.MultiTable08Id = MultiTable08Id;
    }

    /** called by internal mechanisms, do not call yourself. */
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getMultiTable08Dao() : null;
    }
    ...
    public Long getMultiTable08Id() {
        return MultiTable08Id;
    }

    public void setMultiTable08Id(Long MultiTable08Id) {
        this.MultiTable08Id = MultiTable08Id;
    }

    /** To-one relationship, resolved on first access. */
    public MultiTable09 getMultiTable09() {
        Long __key = this.MultiTable08Id;
        if (multiTable09__resolvedKey == null || !multiTable09__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            MultiTable09Dao targetDao = daoSession.getMultiTable09Dao();
            MultiTable09 multiTable09New = targetDao.load(__key);
            synchronized (this) {
                multiTable09 = multiTable09New;
            	multiTable09__resolvedKey = __key;
            }
        }
        return multiTable09;
    }

    public void setMultiTable09(MultiTable09 multiTable09) {
        synchronized (this) {
            this.multiTable09 = multiTable09;
            MultiTable08Id = multiTable09 == null ? null : multiTable09.getId();
            multiTable09__resolvedKey = MultiTable08Id;
        }
    }
